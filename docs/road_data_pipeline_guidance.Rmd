...
The time difference will vary depending on your system and connection. If this step was successful, you are now ready to move on to [Subsequent Runs](###Subsequent Runs)
...
3. Once you have entered your desired dates, press `Ctrl` + `s` to save the script. Return to the `run-me.R` script and run all or `source` the script using the button at the top of the RStudio interface.
