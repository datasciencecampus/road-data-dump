...
1. In `run-me.R`, chenge the line `test_run <- TRUE` to `test_run <- FALSE`. `TRUE` and `FALSE` are case-sensitive. **Save the file**. You can do this by pressing `Ctrl` + `s`.
...
The format being **"DDMMYYYY"**. Incorrect dates will cause an error (trying to ask for the 31st of February for example). Also, be sure to wrap your dates in either qutation marks or apostrophes. So:
"01072019" is good.
'01072019' is good.
"01072019' is bad.
01072019 is bad.
