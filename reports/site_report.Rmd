...
midas_sites <- filter(sitetypes, type == "midas")
# get the 204s that were type midas
midas_204s <- site_Id_204s[site_Id_204s %in% midas_sites$sites.Id]
# subset the midas df by these 204 site IDs
midas_204s <- midas_sites[midas_sites$sites.Id %in% midas_204s, ]

```

```{r echo=FALSE,fig.align='center'}
# plot of 204s
counts <- c(length(unique(midas_sites$sites.Id)), length(unique(midas_204s$sites.Id)))
...
There were <strong class="navy">`r format(length(unique(midas_sites$sites.Id)), big.mark = ",")`</strong> site IDs of the MIDAS type.
...
This means that <strong class="navy">`r round(length(unique(midas_204s$sites.Id)) / length(unique(midas_sites$sites.Id)) * 100, digits = 0)` % (rounded)</strong> of the MIDAS IDs contained no content for this date range.

MIDAS sites represent <strong class="navy">`r round(length(unique(midas_sites$sites.Id)) / length(all_queried_siteIds), digits = 2)` % (to 2 d.p.)</strong> of all sites present.
...
```{r include=FALSE}
# tidy up
rm(list = c("midas_sites", "midas_204s"))
...
tame_sites <- filter(sitetypes, type == "tame")
# get the 204s that were type tame
tame_204s <- site_Id_204s[site_Id_204s %in% tame_sites$sites.Id]
# subset the tame df by these 204 site IDs
tame_204s <- tame_sites[tame_sites$sites.Id %in% tame_204s, ]

```

```{r echo=FALSE,fig.align='center'}
# plot of 204s
counts <- c(length(unique(tame_sites$sites.Id)), length(unique(tame_204s$sites.Id)))
...
There were <strong class="navy">`r format(length(unique(tame_sites$sites.Id)), big.mark = ",")`</strong> site IDs of the TAME type.
...
This means that <strong class="navy">`r round(length(unique(tame_204s$sites.Id)) / length(unique(tame_sites$sites.Id)) * 100, digits = 0)` % (rounded)</strong> of the TAME IDs contained no content for this date range.

TAME sites represent <strong class="navy">`r round(length(unique(tame_sites$sites.Id)) / length(all_queried_siteIds), digits = 2)` % (to 2 d.p.)</strong> of all sites present.
...
```{r include=FALSE}
# tidy up
rm(list = c("tame_sites", "tame_204s"))
...
tmu_sites <- filter(sitetypes, type == "tmu")
# get the 204s that were type tmu
tmu_204s <- site_Id_204s[site_Id_204s %in% tmu_sites$sites.Id]
# subset the tmu df by these 204 site IDs
tmu_204s <- tmu_sites[tmu_sites$sites.Id %in% tmu_204s, ]

```

```{r echo=FALSE,fig.align='center'}
# plot of 204s
counts <- c(length(unique(tmu_sites$sites.Id)), length(unique(tmu_204s$sites.Id)))
...
There were <strong class="navy">`r format(length(unique(tmu_sites$sites.Id)), big.mark = ",")`</strong> site IDs of the TMU type.
...
This means that <strong class="navy">`r round(length(unique(tmu_204s$sites.Id)) / length(unique(tmu_sites$sites.Id)) * 100, digits = 0)` % (rounded)</strong> of the TMU IDs contained no content for this date range.

TMU sites represent <strong class="navy">`r round(length(unique(tmu_sites$sites.Id)) / length(all_queried_siteIds), digits = 2)` % (to 2 d.p.)</strong> of all sites present.
